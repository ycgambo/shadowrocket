...
class Server extends Configurable {
        ...
        switch ($connection->stage) {
            ...
            case self::STAGE_ADDR:
                ...
                if (strlen($buffer) > $header_len) {
                    $tunnel->send(substr($buffer, $header_len));
                }
        }
    }
    ...
    public function getReady() {
        $worker = new Worker('tcp://0.0.0.0:' . $this->_config['port']);
     ...
     * @return array|bool
     *
     * @see https://github.com/shadowsocks/shadowsocks/blob/master/shadowsocks/asyncdns.py
     *
     */
